...
public class Ej03Persona {
    //Realizar una clase llamada Ej03Persona en el paquete de entidades que tengan los siguientes atributos: 
    ...
    public Ej03Persona(String nombre, int edad, String sexo, double peso, double altura) {
        this.nombre = nombre;
        this.edad = edad;
        this.sexo = sexo;
        this.peso = peso;
